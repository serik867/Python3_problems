...
def intToRoman( num: int) -> str:
    dict_roman = {1000: "M", 900: "CM",500: "D",400: "CD",100: "C",90: "XC",50: "L",
    ...
    for key in dict_roman:
        while (num >= key):
            num-=key
            roman+=dict_roman[key]
    
    return roman

test_cases = [3,5,4,6,9,10,100,99,88,1000,999,646,1000,3993]


for i in range(len(test_cases)):
    print("Test case for - " + str(test_cases[i]))
    print(intToRoman(test_cases[i]))
